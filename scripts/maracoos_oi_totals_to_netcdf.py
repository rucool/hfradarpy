...
@purpose Convert Rutgers generated MARACOOS Optimal Interpolation Surface Current MAT files to NetCDF4 format
"""
import logging
import os
import pandas as pd
...
save_dir = '/home/codaradm/data_reprocessed/totals/maracoos/nc_oi/5MHz/'
