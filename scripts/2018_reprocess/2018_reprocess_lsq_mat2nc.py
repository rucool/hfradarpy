...
mat_dir = '/Volumes/home/codaradm/data_reprocessed/totals/totals/maracoos/lsq/5MHz/'
save_dir = '/Users/mikesmith/Documents/2018_codar_reprocess/lsq/'
threshold = dict(u_err=1.25, v_err=1.25)
grid_file = '../../totals/grid_files/OI_6km_Grid_Extend.txt'

sub_dirs = ['2017_02', '2017_03', '2017_04', '2017_05', '2017_06']
...
for sub_dir in sub_dirs:
    ...
    for mat_file in files:
        functions.mat_to_netcdf4.main(grid, mat_file, save_path, user_attributes, flags=threshold, method='lsq')
