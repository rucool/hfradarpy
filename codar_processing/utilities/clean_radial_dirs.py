...
import shutil
import sys
from codar_processing.src.common import create_dir, timestamp_from_lluv_filename
...
source_dirs = ['/Volumes/boardwalk/codaradm/data/radials', '/Volumes/boardwalk/codaradm/data/radials_qc']  # main directory that contains radial files
...
for p in source_dirs:
    ...
    site_dirs = [os.path.join(p, o) for o in os.listdir(p) if os.path.isdir(os.path.join(p, o))]
